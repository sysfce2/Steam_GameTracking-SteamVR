  ...
  var _,
    _ = {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        function _(_) {
          const { frame: _ } = (0, _._)();
          return (0, _._)(() => _._.gamepadFocusAllowed)
            ? _.createElement(_, {
                actionParams: () => {
                  var _, _, _, _;
                  return {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        class _ {
          ...
          get theaterFrame() {
            return this.getLocalFrameAtExclusiveDockLocation(_._.Theater);
          }
          get isTheaterMode() {
          ...
          _setDockLocation(_, _) {
            ...
            const _ =
              null !== (_ = this.m_mapDockLocations.get(_)) && void 0 !== _
                ...
                : _._.Dashboard;
            if (_ !== _) {
              if ((_(_) && this.m_mapExclusiveDockLocations.delete(_), _(_))) {
      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        const _ = (0, _._)(function (_) {
                ...
                (_ =
                  null === VRHTML || void 0 === VRHTML
                    ...
                    : VRHTML.VRProperties.GetBoolProperty(
                        "/user/head",
                        _._.Hmd_ForceRoomViewOutsideChaperone_Bool,
                      )) &&
                void 0 !== _ &&
                _ &&
                _._.settings.get(_._)) ||
                0 == _._.Instance.SceneAppKey.length) &&
                ...
                !_ &&
                  _.createElement(
                    ...
                    _.createElement(
                      ...
                      (0, _._)("#Chaperone_ReturnToPlayArea"),
                    ),
                    _.createElement(
                      "p",
                      {
                      ...
                      " ",
                      (0, _._)("#Chaperone_Bubble_Forbidden"),
                      " ",
                    ),
                  ),
                _.createElement(
          ...
          _ = (0, _._)(function () {
            return !!(null === VRHTML || void 0 === VRHTML
              ...
              _._.m_bIsRoomViewForcedOnByChaperone &&
              0 == _._.roomSetupStep
              ? _._.isOOBE || "recovery" == _._.bareSessionMode
                ? null
                : _.createElement(
                    _._,
                    {
        ...
        function _(_, _, _) {
          const _ = _.useMemo(
            ...
            _ = _.useMemo(() => {
              const _ = _.getItem(_);
              return void 0 === _ ? _ : JSON.parse(_);
            }, [_, _]),
            [_, _] = _.useState(_);
          return [
            _,
        ...
        const _ = (0, _._)(function (_) {
            var _, _;
            const { show: _ = !1 } = _,
              [_, _] = _("local", "input_focus_devui_tall", !0);
            const [_, _] = (function (_, _) {
              return _("session", _, _);
            })("input_focus_devui_stay_hidden", !1);
            _.useEffect(() => {
              _ || _(!1);
            }, [_]);
            const _ = "input_focus_devui_show_force_focus",
              [_, _] = _.useState(
                JSON.parse(
                  null !== (_ = sessionStorage.getItem(_)) && void 0 !== _
                    ? _
              ...
              _ = () => {
                const _ = !_;
                _(_), sessionStorage.setItem(_, JSON.stringify(_));
              },
              [_, _] = _.useState(!1),
              _ = (function (_ = !0) {
                ...
                const _ = _.useMemo(() => new Map(), []),
                  _ =
                    ...
                    _.useMemo(() => {
                      var _, _, _, _, _, _;
                      function _(_) {
                        if ("number" == typeof _) return _._[_];
                      }
                      function _(_) {
                        var _;
        ...
        let _ = (_ = class extends _.Component {
          static bootstrap(_) {
            return (0, _._)(this, void 0, void 0, function* () {
              ...
              const _ = 1e3 * (null !== (_ = 1777429667) ? _ : 0);
              console.log(
